...
export default {
  ...
  'install.pin.title': 'Pin BROZER to your toolbar',
  'install.pin.body': 'Click the pin in the side panel header above. This adds BROZER to your browser toolbar for one-click access.',
  ...
  'ob.btn.start': 'Start',
  'ob.cloud.body': 'WebBrain Compass is ready with a free daily allowance. Selected Compass conversations may be retained and used to improve WebBrain while Help Improve BROZER is on by default. You can turn it off in Settings → General.',
  ...
  'st.display.help_improve.label': 'Help Improve BROZER',
