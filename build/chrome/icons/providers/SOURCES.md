...
(`@lobehub/icons-static-svg`, MIT). Filenames match BROZER provider ids.
...
| local_openai_proxy, webgpu | BROZER-authored generic local-runtime marks |
...
| brozer_cloud | BROZER extension icon |
