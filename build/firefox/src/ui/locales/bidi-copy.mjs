// English fallback for experimental Firefox-only setup; shared to keep locale keys aligned.
export default {
  ...
  "st.bidi.invalid_port": "Choose a port from 1024 to 65535.",
  "st.bidi.enabled": "Enabled for new Act/Dev tasks.",
  "st.bidi.disabled": "Using standard Firefox automation.",
  "st.bidi.connecting": "Connecting…",
  "st.bidi.connected": "Connected to Firefox.",
  "st.bidi.failed": "Connection failed.",
