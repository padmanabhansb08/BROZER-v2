...
const englishApocalypseModeCopy = {
  ...
  'ap.subtitle': 'BROZER, ready when the internet isn’t.',
  ...
  'ap.catalog.desc': 'Choose a language, then pick text only for a smaller download or articles with images for the complete experience. BROZER can search either version while offline.',
  ...
  'ap.import.search_note': 'Downloads from the catalog always support full-text search. A file you supply yourself may only support title search, because not every archive is published with a search index. BROZER checks after import and tells you which one you have.',
  ...
  'ap.delete_external': 'Remove this archive from BROZER? The offline Wikipedia file on your device will be retained.',
